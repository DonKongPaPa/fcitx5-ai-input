...
echo ">> 安装 Flutter 资产 → $PREFIX/share/fcitx5-voiceinput/flutter"
mkdir -p "$PREFIX/share/fcitx5-voiceinput/flutter"
cp -a "$HERE/flutter-ui/flutter_assets" "$PREFIX/share/fcitx5-voiceinput/flutter/"
cp "$HERE/flutter-ui/icudtl.dat" "$PREFIX/share/fcitx5-voiceinput/flutter/"
